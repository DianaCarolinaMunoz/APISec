...
fig_count = plot_by_language(df_total, lenguaje, group_by=group_by, mode="count")
st.plotly_chart(fig_count, use_container_width=True)

fig_percent = plot_by_language(df_total, lenguaje, group_by=group_by, mode="percent")
